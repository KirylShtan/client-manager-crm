              ...
              {files.map((file) => (
                ...
                >
                  ...
                  <td style={tdActionsStyle}>
                    <button style={buttonStyle} onClick={() => handleDownload(file)}>Download</button>
                    <button style={buttonStyle} onClick={() => handleDelete(file)}>Delete</button>
                    <button style={buttonStyle} onClick={() => handlePreview(file)}>Preview</button>
                  </td>
                </tr>
              ))}
            </tbody>
